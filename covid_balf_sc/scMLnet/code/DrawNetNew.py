...
for line in islice(LigRec,0,None):
   ...
   edgeWidthDict0[((Lig,"Ligand"),(Rec,"Receptor"))] = 2
...
nodeColorDict0 = getColor(LigList,nodeColorDict0,"Ligand","#000000")
nodeColorDict0 = getColor(RecList,nodeColorDict0,"Receptor","#FF6600")
nodeColorDict0 = getColor(TFList,nodeColorDict0,"TF","#006600")
nodeColorDict0 = getColor(TarList,nodeColorDict0,"Target gene","#0000FF")
nodeLabelColorDict0 = nodeColorDict0
...
for l in LayNodeListDict:
    for n in LayNodeListDict[l]:
        if l == "Ligand":
            nodeSizeDict[(n,l)] = 0.05
            nodeLabelSizeDict[(n,l)] = 9
        elif l == "Receptor":
            nodeSizeDict[(n,l)] = 0.05
            nodeLabelSizeDict[(n,l)] = 9
        elif l == "TF":
            nodeSizeDict[(n,l)] = 0.03
            nodeLabelSizeDict[(n,l)] = 7
        elif l == "Target gene":
...
def Coords(gmp_unique,lay,nodeCoorDict):
	...
	for i in range(Count):
		...
		nodeCoorDict[(gmp_unique[i],lay)] = (-0.8+yu*dis, -5-zheng*dis)
	return nodeCoorDict
...
def Coords3(gmp_unique,lay,nodeCoorDict):
        ...
        for i in range(Count):
                ...
                nodeCoorDict[(gmp_unique[i],lay)] = (-0.8+yu*0.4,  -5-zheng*0.5)
        return nodeCoorDict
...
fig.savefig(outPic,dpi = 500)

print ("save net:",outPic)
